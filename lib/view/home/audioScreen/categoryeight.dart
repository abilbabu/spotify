...
class Categoryeight extends StatefulWidget {
  final String title;
  final String image;
  const Categoryeight({super.key, required this.title, required this.image});

  @override
  State<Categoryeight> createState() => _CategoryeightState();
}

class _CategoryeightState extends State<Categoryeight> {
