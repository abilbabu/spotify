...
class Categoryfour extends StatefulWidget {
  final String title;
  final String image;
  const Categoryfour({super.key, required this.title, required this.image});

  @override
  State<Categoryfour> createState() => _CategoryfourState();
}

class _CategoryfourState extends State<Categoryfour> {
