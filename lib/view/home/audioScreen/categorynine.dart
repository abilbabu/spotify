...
class Categorynine extends StatefulWidget {
  final String title;
  final String image;
  const Categorynine({super.key, required this.title, required this.image});

  @override
  State<Categorynine> createState() => _CategorynineState();
}

class _CategorynineState extends State<Categorynine> {
