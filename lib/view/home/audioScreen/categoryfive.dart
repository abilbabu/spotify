...
class Categoryfive extends StatefulWidget {
  final String title;
  final String image;
  const Categoryfive({super.key, required this.title, required this.image});

  @override
  State<Categoryfive> createState() => _CategoryfiveState();
}

class _CategoryfiveState extends State<Categoryfive> {
